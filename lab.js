...
given by a user also if we have to run atleast one block of code and have to handle errors too by throwing a error message 
at o/p window.
...
and have to execute a block of code atleast one time in program without relying on condition at first execution.
Example :- Countdown timer,User input validation,Menu selection in apps
*/
//NOTE:- do-while loop is one of the least used loop among other 2 loops. and it executes atleast 1 time in program
